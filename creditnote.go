...
type CreditNoteParams struct {
	...
	CreditAmount    *int64                  `form:"credit_amount" json:"credit_amount"`
	Invoice         *string                 `form:"invoice" json:"invoice"`
	Lines           []*CreditNoteLineParams `form:"lines" json:"lines"`
	Memo            *string                 `form:"memo" json:"memo"`
	OutOfBandAmount *int64                  `form:"out_of_band_amount" json:"out_of_band_amount"`
	Reason          *string                 `form:"reason" json:"reason"`
	Refund          *string                 `form:"refund" json:"refund"`
	RefundAmount    *int64                  `form:"refund_amount" json:"refund_amount"`
}
...
type CreditNoteLineParams struct {
	...
	InvoiceLineItem   *string   `form:"invoice_line_item" json:"invoice_line_item"`
