...
type OrderParams struct {
	...
	Shipping *ShippingParams    `form:"shipping" json:"shipping"`
}
...
type OrderUpdateParams struct {
	Params                 `form:"*" json:"*"`
	Coupon                 *string                    `form:"coupon" json:"coupon"`
	SelectedShippingMethod *string                    `form:"selected_shipping_method" json:"selected_shipping_method"`
	Shipping               *OrderUpdateShippingParams `form:"shipping" json:"shipping"`
...
type OrderListParams struct {
	...
	Status            *string                        `form:"status" json:"status"`
	StatusTransitions *StatusTransitionsFilterParams `form:"status_transitions" json:"status_transitions"`
	UpstreamIDs       []*string                      `form:"upstream_ids" json:"upstream_ids"`
}
...
type StatusTransitionsFilterParams struct {
	Canceled       *int64            `form:"canceled" json:"canceled"`
	CanceledRange  *RangeQueryParams `form:"canceled" json:"canceled"`
	Fulfilled      *int64            `form:"fulfilled" json:"fulfilled"`
	FulfilledRange *RangeQueryParams `form:"fulfilled" json:"fulfilled"`
	Paid           *int64            `form:"paid" json:"paid"`
	PaidRange      *RangeQueryParams `form:"paid" json:"paid"`
	Returned       *int64            `form:"returned" json:"returned"`
	ReturnedRange  *RangeQueryParams `form:"returned" json:"returned"`
}
...
type OrderPayParams struct {
	Params         `form:"*" json:"*"`
	ApplicationFee *int64        `form:"application_fee" json:"application_fee"`
	Customer       *string       `form:"customer" json:"customer"`
	Email          *string       `form:"email" json:"email"`
