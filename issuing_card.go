...
type AuthorizationControlsParams struct {
	AllowedCategories []*string                                           `form:"allowed_categories" json:"allowed_categories"`
	BlockedCategories []*string                                           `form:"blocked_categories" json:"blocked_categories"`
	MaxApprovals      *int64                                              `form:"max_approvals" json:"max_approvals"`
	SpendingLimits    []*IssuingAuthorizationControlsSpendingLimitsParams `form:"spending_limits" json:"spending_limits"`

	// The following parameter only applies to Cardholder
	SpendingLimitsCurrency *string `form:"spending_limits_currency" json:"spending_limits_currency"`
...
type IssuingCardShippingParams struct {
	...
	Speed   *string        `form:"speed" json:"speed"`
...
type IssuingCardParams struct {
	...
	Name                  *string                      `form:"name" json:"name"`
	ReplacementFor        *string                      `form:"replacement_for" json:"replacement_for"`
	ReplacementReason     *string                      `form:"replacement_reason" json:"replacement_reason"`
	Status                *string                      `form:"status" json:"status"`
	Shipping              *IssuingCardShippingParams   `form:"shipping" json:"shipping"`
	Type                  *string                      `form:"type" json:"type"`
}
