...
type PaymentMethodParams struct {
	Params         `form:"*" json:"*"`
	AUBECSDebit    *PaymentMethodAUBECSDebitParams `form:"au_becs_debit" json:"au_becs_debit"`
	...
	FPX            *PaymentMethodFPXParams         `form:"fpx" json:"fpx"`
	SepaDebit      *PaymentMethodSepaDebitParams   `form:"sepa_debit" json:"sepa_debit"`
